...
.controller('CategoriesCtrl', function($scope, Category) {
      ...
      var rootCategory = Category.get({categoryId: 'categories'}, function(rootCategory) {
            $scope.categories = rootCategory.subcategories;

            // loop through each cztegory
            // if there are not subcategories
            // chnage url to products
